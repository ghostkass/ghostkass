...
> 🕌 *Chaque ligne de code peut être une prière pour un monde meilleur — et pour une Afrique qui bâtit son propre futur numérique.*
...
<div align="center">
<img src="https://skillicons.dev/icons?i=nodejs,express,react,ts,tailwind,postgres,prisma,redis,docker,nginx,ubuntu,python,figma,git&perline=7" />
</div>
...
|---|---|
| **Backend & API** | Node.js · Fastify · Express · PostgreSQL · Prisma · Redis · MinIO |
| **Frontend** | React · Next.js · TypeScript · Tailwind CSS · Alpine.js |
| **Infra & DevOps** | Ubuntu Server · KVM/QEMU · Nginx · PM2 · Docker · Dell PowerEdge |
| **Design & IA** | Figma · Canva · Leonardo AI · Whisper AI · Photoshop |
| **CMS & No-Code** | WordPress · Elementor Pro · WooCommerce |
| **Data** | Python · Leaflet · Data Visualization |
...
<table>
<tr>
<td align="center" width="25%">💡<br/><b>Création</b><br/><sub>Le code comme art et langage universel</sub></td>
<td align="center" width="25%">🤝<br/><b>Impact</b><br/><sub>Construire pour les gens, pas pour les machines</sub></td>
<td align="center" width="25%">🌱<br/><b>Transmission</b><br/><sub>Partager la connaissance, enseigner, inspirer</sub></td>
...
### *"L'Afrique n'a pas besoin de suivre le futur — elle doit le coder."*
**— Ghost'n'Bone**
